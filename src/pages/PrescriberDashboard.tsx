    ...
    <div className="bg-[#F3F6FA] min-h-screen pt-24 pb-32 relative">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          ...
          <Link to="/prescritor/rx-builder" className="flex items-center gap-2 px-6 py-4 bg-[#2B5DB6] text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-[#152C60] transition-colors shadow-lg">
            ...
            {activeTab === 'overview' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white rounded-3xl p-8 shadow-sm border border-[#152C60]/5">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                      ...
                      <div className="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <Link to="/prescritor/rx-builder" className="w-8 h-8 rounded-full bg-[#152C60] text-white flex items-center justify-center hover:bg-[#2B5DB6] transition-colors shrink-0">
                          <Plus size={14} />
                        </Link>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  ...
                  {/* Comunidade */}
                  <div className="bg-gradient-to-br from-[#152C60] to-[#2B5DB6] text-white rounded-3xl p-8 shadow-xl relative overflow-hidden group">
                     ...
                     <p className="text-sm font-medium text-white/80 mb-6 relative z-10">Compartilhe protocolos, interaja com pacientes e construa sua autoridade clínica.</p>
            ...
            {activeTab === 'formulas' && (
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#152C60]/5">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                  ...
                  <Link to="/prescritor/rx-builder" className="w-full md:w-auto px-6 py-3 bg-[#152C60] text-white font-black uppercase tracking-widest text-[10px] rounded-xl hover:bg-[#2B5DB6] transition-colors flex items-center justify-center gap-2 shadow-lg">
